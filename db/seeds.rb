...
guard = Guard.create!(user_id: user.id, name: 'Legolas', specialty: 'nice hair', available: false, location: 'Treptower Park', rate: 5000, picture: 'https://res.cloudinary.com/dfcud6por/image/upload/c_fill,h_700,w_700/v1542721286/legolas_profile.jpg', cover: 'https://res.cloudinary.com/dfcud6por/image/upload/v1542720254/Legolas.jpg')
Guard.create!(user_id: user.id + 1, name: 'Darth Vader', specialty: 'faceless', location: 'Alexanderplatz', rate: 700000, picture: 'https://res.cloudinary.com/dfcud6por/image/upload/c_fill,h_700,w_700/v1542715217/Darth_Vader.jpg', cover: 'https://res.cloudinary.com/dfcud6por/image/upload/v1542722276/Star-Wars-Darth-Vader-Wallpaper.jpg' )
Guard.create!(user_id: user.id + 2, name: 'Gimli', specialty: 'pocket-sized', location: 'Moritzplatz, Berlin', rate: 4000, picture: 'https://res.cloudinary.com/dfcud6por/image/upload/c_fill,h_700,w_700/v1542715218/gimli.jpg', cover: 'https://res.cloudinary.com/dfcud6por/image/upload/v1542722276/Gimli_cover.jpg' )
Guard.create!(user_id: user.id + 3, name: 'Bronn', specialty: 'drunkard', location: 'Berliner Dom', rate: 500, picture: 'https://res.cloudinary.com/dfcud6por/image/upload/c_fill,h_700,w_700/v1542715217/bronn.jpg', cover: 'https://res.cloudinary.com/dfcud6por/image/upload/v1542722274/Bronn-game-of-thrones-22077692-1024-576.png' )
Guard.create!(user_id: user.id + 4, name: 'Thor', specialty: 'strong', location: 'Kottbusser Tor', rate: 70000, picture: 'https://res.cloudinary.com/dfcud6por/image/upload/c_fill,h_700,w_700/v1542721686/thor-profile.jpg', cover: 'https://res.cloudinary.com/dfcud6por/image/upload/v1542715221/thor.jpg')
